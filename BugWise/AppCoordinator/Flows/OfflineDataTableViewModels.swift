...
enum RetrunSectionHeaderTypeEnum {
    case description
    case diagnosis
    case firstLineTherapy
    case secondLineTherapy
...
extension RetrunSectionHeaderTypeEnum {
    var title: String {
        ...
        case .firstLineTherapy: return "First Line Therapy"
        case .secondLineTherapy: return "Second Line Therapy"
        ...
        case .methodOfAdministration: return "Method of Administration"
    ...
    var image: UIImage {
        ...
        case .firstLineTherapy: return #imageLiteral(resourceName: "therapy_y")
        case .secondLineTherapy: return #imageLiteral(resourceName: "therapy 2_y")
...
class ReturnHeaderModel: BaseReturnModel {
    ...
    init(type: EntitiesType, title: String?, tradeAction: (voidBlock)?) {
        self.type = type
        self.title = title
